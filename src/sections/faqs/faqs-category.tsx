...
const CATEGORIES = [
  ...
  { label: 'Betalning', icon: `${CONFIG.assetsDir}/assets/icons/faqs/ic-payment.svg`, href: '#' },
  { label: 'Leverans', icon: `${CONFIG.assetsDir}/assets/icons/faqs/ic-delivery.svg`, href: '#' },
  {
    label: 'Problem med produkten',
  ...
  {
    label: 'Garantier och försäkringar',
